...
if sa_space:
    ...
    post(v1("space"), {
        ...
        "name": "SearchAudit",
        "description": {
            "plain": {"value": "SearchAudit ETL pipeline — architecture, ADRs, and implementation notes.", "representation": "plain"},
        },
    })
...
cp_root = create_page(
    BAZZONIARE_SPACE_ID, "confluence-publisher", BAZZONIARE_ROOT,
...
r.raise_for_status()
hw = r.json()
r2 = session.put(v2(f"pages/{HELLO_WORLD_PAGE_ID}"), json={
    "id": HELLO_WORLD_PAGE_ID,
    "status": "current",
    "title": hw["title"],
    "parentId": cp_root,
    "version": {"number": hw["version"]["number"] + 1, "message": "moved to confluence-publisher section"},
...
SA_DOC_PAGES: list[tuple[str, str, str]] = [
    ...
    # ADRs
    ("docs/adr/ADR-004-config-driven-edge-case-handling.md",   "ADR-004: Config-Driven Edge Case Handling", sa_adrs),
    ("docs/adr/ADR-004-moving-rate-calculations-review.md",    "ADR-004: Moving Rate Calculations Review",  sa_adrs),
    ...
    ("docs/adr/CONFIG_AUDIT_AND_HYBRID_IMPLEMENTATION.md",     "Config Audit & Hybrid Implementation",      sa_adrs),
    ("docs/adr/HYBRID_CONFIG_ARCHITECTURE_ALIGNED.md",         "Hybrid Config Architecture",                sa_adrs),
    ("docs/adr/PRE_PROCESSOR_ORPHANED_METHODS_ANALYSIS.md",    "Pre-Processor: Orphaned Methods",           sa_adrs),
    ...
    ("docs/SESSION_ID_DUAL_FORMAT_IMPLEMENTATION.md", "Session ID: Dual Format Implementation", sa_impl),
    ("docs/SESSION_ID_FILTERING_IMPLEMENTATION.md", "Session ID: Filtering Implementation",   sa_impl),
    ("docs/TODO_RESOLUTION_DYNAMIC_SEARCH_START.md","TODO: Dynamic Search Start Resolution",  sa_impl),
    ...
    ("docs/KATE_SOURCE_PRODUCT_CLARIFICATIONS.md",  "Kate: Source Product Clarifications",    sa_analysis),
